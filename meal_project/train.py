...
from customdataset import MealDataset
...
class Classifier_Meal :
        ...
        for epoch in range (start_epoch, epochs) :
            ...
            with torch.no_grad() :
                ...
                if val_acc > best_val_acc :
                    torch.save(self.model.state_dict(), "./meal_project/meal_best.pt")
                ...
                }, "./meal_project/meal_checkpoint.pt")
    ...
    def save_results_to_csv(self):
        ...
        df.to_csv('./meal_project/visualization/train_val_result.csv', index=False)
    ...
    def plot_loss(self):
        ...
        plt.ylabel('Loss')
        plt.legend()
        plt.savefig("./meal_project/visualization/loss_plot.jpg")
    ...
    def plot_accuracy(self):
        ...
        plt.ylabel('Loss')
        plt.legend()
        plt.savefig("./meal_project/visualization/accuracy_plot.jpg")

    def run(self, args) :
        self.model = efficientnet_b0(pretrained=True)
        self.model.classifier[0] = nn.Dropout(p=0.5, inplace=True)
        self.model.classifier[1] = nn.Linear(1280, out_features=250)
        ...
        train_dataset = MealDataset(args.train_dir, transform=train_transforms)
        val_dataset = MealDataset(args.val_dir, transform=val_transforms)
...
if __name__ == "__main__" :
    ...
    parser.add_argument("--train_dir", type=str, default="./meal_project/meal_dataset/train_labels.csv",
                        help="directory path to the training dataset")
    
    parser.add_argument("--val_dir", type=str, default="./meal_project/meal_dataset/val_labels.csv",
