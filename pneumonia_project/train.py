...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dummy:
        ...
        train_dataset = MyDataset("./pneumonia_project/pneumonia_dataset/train", transforms=train_transform)
        val_dataset = MyDataset("./pneumonia_project/pneumonia_dataset/valid", transforms=val_transform)
...
def save_checkpoint(state, is_best, filename='./pneumonia_project/checkpoint.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, './pneumonia_project/model_best.pth.tar')
