...
class Classifier_Sports :
        ...
        for epoch in range (start_epoch, epochs) :
            ...
            with torch.no_grad() :
                ...
                if val_acc > best_val_acc :
                    torch.save(self.model.state_dict(), "./sports_project/sports_best.pt")
    ...
    def save_results_to_csv(self):
        ...
        df.to_csv('./sports_project/train_val_result.csv', index=False)
    ...
    def plot_loss(self):
        ...
        plt.ylabel('Loss')
        plt.legend()
        plt.savefig("./sports_project/loss_plot.jpg")
    ...
    def plot_accuracy(self):
        ...
        plt.ylabel('Loss')
        plt.legend()
        plt.savefig("./sports_project/accuracy_plot.jpg")

    def run(self, args) :
        self.model = efficientnet_b0(pretrained=True)
        self.model.classifier[0] = nn.Dropout(p=0.5, inplace=True)
        self.model.classifier[1] = nn.Linear(1280, out_features=99)
        ...
        train_dataset = SportsDataset_csv(args.csv_dir, mode="train", transform=train_transforms)
        val_dataset = SportsDataset_csv(args.csv_dir, mode="valid", transform=val_transforms)
...
if __name__ == "__main__" :
    ...
    parser.add_argument("--checkpoint_path", type=str, default="./sports_project/sports_checkpoint.pt", 
